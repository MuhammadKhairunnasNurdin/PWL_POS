...
{{--                @dd(url('/penjualan/'.$penjualan->penjualan_id))--}}
                <form method="POST" action="{{ url('/penjualan/'.$penjualan->penjualan_id) }}" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <label class="col-11 control-label col-form-label">Kode Penjualan:  {{$penjualan->penjualan_kode}} </label>
                    </div>
                    <div class="form-group row">
                    ...
                    @foreach ($details as $detail)
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-11">
                                <input type="number" class="form-control" id="jumlah" name="jumlah[]" value="{{ old('jumlah.'.$loop->index, $detail->jumlah) }}" required>
                                @error('jumlah')
                                <small class="form-text text-danger">{{ $message }}</small>
                                @enderror
                            </div>
